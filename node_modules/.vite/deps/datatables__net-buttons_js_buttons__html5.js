...
function _addToZip(zip, obj) {
  ...
  import_jquery.default.each(obj, function(name, val) {
...
function _createNode(doc, nodeName, opts) {
  ...
  if (opts) {
    if (opts.attr) {
      (0, import_jquery.default)(tempNode).attr(opts.attr);
    }
    if (opts.children) {
      import_jquery.default.each(opts.children, function(key, value) {
...
var _excelSpecials = [
  ...
  { match: /^[\d]{4}\-[01][\d]\-[0123][\d]$/, style: 67, fmt: function(d) {
...
jquery_dataTables_default.ext.buttons.copyHtml5 = {
  ...
  action: function(e, dt, button, config) {
    ...
    var hiddenDiv = (0, import_jquery.default)("<div/>").css({
      height: 1,
      width: 1,
      overflow: "hidden",
      position: "fixed",
    ...
    var textarea = (0, import_jquery.default)("<textarea readonly/>").val(output).appendTo(hiddenDiv);
    ...
    var message = (0, import_jquery.default)(
      "<span>" + dt.i18n(
        "buttons.copyKeys",
    ...
    textarea[0].focus();
    textarea[0].select();
    var container = (0, import_jquery.default)(message).closest(".dt-button-info");
    var close = function() {
      container.off("click.buttons-copy");
      (0, import_jquery.default)(document).off(".buttons-copy");
      dt.buttons.info(false);
    };
    container.on("click.buttons-copy", close);
    (0, import_jquery.default)(document).on("keydown.buttons-copy", function(e2) {
      if (e2.keyCode === 27) {
        close();
...
jquery_dataTables_default.ext.buttons.excelHtml5 = {
  ...
  action: function(e, dt, button, config) {
    ...
    var getXml = function(type) {
      ...
      return import_jquery.default.parseXML(str);
    };
    ...
    var mergeCells = function(row, colspan) {
      var mergeCells2 = (0, import_jquery.default)("mergeCells", rels);
      ...
      (0, import_jquery.default)("row:eq(" + (row - 1) + ") c", rels).attr("s", "51");
    };
    ...
    if (config.header) {
      ...
      (0, import_jquery.default)("row:last c", rels).attr("s", "2");
    }
    dataStartRow = rowPos;
    ...
    (0, import_jquery.default)("worksheet", rels).prepend(cols);
    ...
    (0, import_jquery.default)("sheets sheet", workbook).attr("name", _sheetname(config));
    if (config.autoFilter) {
      (0, import_jquery.default)("mergeCells", rels).before(_createNode(rels, "autoFilter", {
        attr: {
          ref: "A" + dataStartRow + ":" + createCellPos(data.header.length - 1) + dataEndRow
        }
      }));
      (0, import_jquery.default)("definedNames", workbook).append(_createNode(workbook, "definedName", {
        attr: {
    ...
    if ((0, import_jquery.default)("mergeCells", rels).children().length === 0) {
      (0, import_jquery.default)("mergeCells", rels).remove();
    }
    var jszip = _jsZip();
    var zip = new jszip();
    var zipConfig = {
...
jquery_dataTables_default.ext.buttons.pdfHtml5 = {
  ...
  action: function(e, dt, button, config) {
    ...
    var rows = [];
    if (config.header) {
      rows.push(import_jquery.default.map(data.header, function(d) {
        return {
    ...
    for (var i = 0, ien = data.body.length; i < ien; i++) {
      rows.push(import_jquery.default.map(data.body[i], function(d) {
        if (d === null || d === void 0) {
          d = "";
        }
        return {
    ...
    if (config.footer && data.footer) {
      rows.push(import_jquery.default.map(data.footer, function(d) {
        return {
          text: typeof d === "string" ? d : d + "",
          style: "tableFooter"
        };
