...
const props = defineProps({ position:{type:Object}});
const form = useForm({
    ...
    <AuthenticatedLayout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="p-4 bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <form @submit.prevent="form.patch(route('position.update',position))" 
                    ...
                    <InputLabel for="name" value="Position"></InputLabel>
